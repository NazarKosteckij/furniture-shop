            ...
            <tbody>
                <c:forEach var="product" items="${products}">
                    <tr class="row" style="height: 60px;">
                        ...
                        <td  class="col s3"> <a class="btn-floating waves-effect waves-light red tooltipped" data-position="left" data-delay="50" data-tooltip="Видалити"  id="<c:out value="${product.id}"/>" onclick="removeProduct(this)" ><i class="material-icons small">delete</i></a>
